...
$H_0$: There is no difference between the average number of pushups of line vs skill players done in two minutes.

$H_A$: The average number of pushups done in two minues by line players is statistically different than that of skill players.
...
It appears, in the graphical results that the skill players with the lowest average do more pushups than almost all the line players in two minutes.  Visually they are very different.
...
The null hypothesis is:$H_0$: There is no difference between the average number of pushups of line vs skill players can do in 2 minutes.
...
A t-test of difference in means gave a p-value of 0.000009421, this is less than .05, so we reject the null hypothesis and conclue we have the evidence of a difference in the average number of pushups done between players in the two positions.